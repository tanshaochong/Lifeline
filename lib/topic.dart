...
class _TopicPage extends State<TopicPage> {
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: ToggleList(
          ...
          children: List.generate(_contentList[0].topics.length, (index) => ToggleListItem(
              leading: Padding(
              ...
              content: Container(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: List.generate(_contentList[0].topics[index].subtopics.length, (innerIndex) => Container(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        ListTile(
                          minLeadingWidth: 5,
                          title: Text(_contentList[0].topics[index].subtopics[innerIndex].title),
                          leading: _contentList[0].topics[index].subtopics[innerIndex].completed ? Icon(Icons.check_box)
                              : Icon(Icons.check_box_outline_blank),
                          onTap: () {
                            setState(() {
                              // navigate to content page
                              _contentList[0].topics[index].subtopics[innerIndex].completed = true;
                            });
                          },
                        ),
                        const SizedBox(
  ...
  void _expansionChangedCallback(int index, bool newValue) {
    ...
    print('Changed expansion status of item  no.${index + 1} to ${newValue ? "expanded" : "shrunk"}.');
  }
}
